...
<x-backend.card>
    ...
    <x-slot name="body">
        ...
        <form action="{{ route('admin.settings.carriers.store') }}" method="POST">
            @csrf()
            ...
            <div class="row mt-4">
                ...
                <div class="col-sm-6 col-md-3">
                    ...
                    <div class="input-group">
                        <input class="form-control" type="text" name="po_box" />
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-8 col-md-5">
                    ...
                    <div class="input-group">
                        <input class="form-control" type="text" name="kra_pin" />
                    </div>
                </div>
            </div>
