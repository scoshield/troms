...
<x-backend.card>
    ...
    <x-slot name="body">
        ...
        <form action="{{ route('admin.settings.vehicles.update', $vehicle->id) }}" method="POST">
            @csrf()
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="mb-3">
                        ...
                        <select class=" js-states form-control" name="carrier_id" id="id_label_single">
                            ...
                            <option value="{{ $carrier->id }}" {{ old("carrier_id")==$carrier->id
            ...
            <div class="row">
                <div class="col-sm-6 col-md-3">
                    ...
                    <div class="input-group">
                        <input value="{{ $vehicle->number }}" class="form-control" type="text" name="number" />
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-6 col-md-3">
                    ...
                    <div class="input-group">
                        <input value="{{ $vehicle->trailer }}" class="form-control" type="text" name="trailer" />
                    </div>
                </div>
            </div>
